      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button onClick={() => scrollToSection('wildfleischverkauf')} className="hover:text-green-200 transition-colors">Wildfleisch</button>
            ...
            {user ? <div className="flex items-center space-x-2">
                ...
                <Button variant="outline" size="sm" onClick={signOut} className="text-green-800 border-white hover:bg-white">
